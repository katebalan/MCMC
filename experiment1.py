...
plt.savefig("results/experiment1/storms.png")
plt.clf()
...
plt.grid(b=True, which='major', color='black', linestyle='-')
plt.grid(b=True, which='minor', color='grey', linestyle='--')
plt.savefig("results/experiment1/markov_chains.png")
plt.clf()
...
plt.grid(b=True, which='major', color='grey', linestyle='-')
plt.grid(b=True, which='minor', color='grey', linestyle='--')
plt.savefig("results/experiment1/distribution.png")
plt.clf()
...
plt.grid(b=True, which='major', color='black', linestyle='-')
plt.grid(b=True, which='minor', color='grey', linestyle='--')
plt.savefig("results/experiment1/rate.png")
plt.clf()

graph = pymc.graph.graph(model)
graph.write_png("results/experiment1/model.png")
